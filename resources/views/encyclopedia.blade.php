...
<div class="container">
  <div class="row">
    <h4 class="main-header deep-orange-text text-darken-4">Encyklopedia</h4>
  ...
  <div class="row">
        <div class="col l12">
          <div class="card orange">
            <div class="card-content white-text">
              <span class="card-title">Przeglądaj wpisy</span>
              <p>
      ...
      <div class="row">
        <div class="col l4">
          <div class="card hoverable">
            <div class="card-image">
              <img src="{{asset('images/encyclopedia/01.jpg')}}">
        ...
        <div class="col l4">
          <div class="card hoverable">
            <div class="card-image">
              <img src="{{asset('images/encyclopedia/02.jpg')}}">
        ...
        <div class="col l4">
          <div class="card hoverable">
            <div class="card-image">
              <img src="{{asset('images/encyclopedia/03.jpg')}}">
              <span class="card-title">Trzeci Wpis</span>
            </div>
            <div class="card-content">
